;;; management-jira.el --- Description -*- lexical-binding: t; -*-
;;
...
;; Homepage: https://github.com/C304095/management-jira
...
(defun management-jira-parse-tasks (tasks)
...
(defun management-jira-create-tasks-outline (tasks epic)
  (dolist (task tasks)
    (let* ((status (plist-get task :status))
      ...
      ;; Create outline-path
      (management-goto-or-create-org-outline-path (list "Planning" epic task-heading))
...
(provide 'management-jira)
;;; management-jira.el ends here
